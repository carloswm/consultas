      ...
      <v-list dense>
        <template>
          <v-list-tile :to="{ name: 'home'}">
            ...
            <v-list-tile-action>Inicio</v-list-tile-action>
          </v-list-tile>
        </template>
        <template>
          <v-list-group>
            ...
            <v-list-tile :to="{ name: 'categorias'}">
              ...
              <v-list-tile-content>
                <v-list-tile-title>Catergorías</v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
            <v-list-tile :to="{ name: ''}">
              <v-list-tile-action>
      ...
      <v-layout justify-center>
        <v-flex text-xs-center>
          <v-card flat tile color="primary" class="white--text">
            <v-card-text class="white--text pt-0">IncanatoIT &copy;2018</v-card-text>
          </v-card>
        </v-flex>
      </v-layout>
    </v-footer>
